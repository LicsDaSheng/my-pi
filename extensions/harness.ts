...
const RATE_LIMIT_PATTERN = /\b429\b|too many requests|rate[\s-]?limit/i;
const NON_RETRYABLE_429_PATTERN =
...
export default function (pi: ExtensionAPI) {
  ...
  pi.on("turn_end", (event) => {
    ...
    // A successful core retry (or any other terminal assistant result) cancels our candidate.
